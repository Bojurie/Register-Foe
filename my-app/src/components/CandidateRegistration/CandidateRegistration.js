    ...
    const { user } = useContext(AuthContext);
      ...
      const validateForm = () => {
        ...
        if (!formData.politicalParty.trim()) {
          alert("Please enter your political party information.");
          return false;
        }
        if (
          !formData.campaignWebsite.trim() ||
          !/^https?:\/\/.+\..+/.test(formData.campaignWebsite)
        ) {
          alert("Please enter a valid campaign website URL.");
          return false;
        }
        ...
        // Validate election info fields (optional fields)
        // ... additional checks if needed ...
