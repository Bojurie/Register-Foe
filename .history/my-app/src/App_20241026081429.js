...
// Fallback loader to show while checking authentication
function LoadingFallback() {
  return <div className="loader">Loading...</div>; // Simple loader component
}

// Protected route with a fallback loader and redirect logic
function ProtectedRoute({ children }) {
  const { user, authChecking } = useAuth();

  if (authChecking) return <LoadingFallback />;
