...
import ElectionComponent from "./components/ElectionComponent /ElectionComponent "; // Correct path
import "./App.css";
import { ThemeProvider } from "./components/ThemeProvider"; // Adjust if necessary
