...
function ProtectedRoute({ children }) {
 ...
 useEffect(() => {
    ...
    document.documentElement.style.setProperty('--button-background', theme.button.background);
    document.documentElement.style.setProperty('--button-color', theme.button.color);
    document.documentElement.style.setProperty('--button-hover-background', theme.button.hoverBackground);
    document.documentElement.style.setProperty('--heading-color', theme.heading.color);
    document.documentElement.style.setProperty('--link-color', theme.text.color);
    document.documentElement.style.setProperty('--link-hover-color', theme.button.hoverBackground);
  }, [theme]);function App() {
  return (
    <ThemeProvider>
      <AuthProvider>
