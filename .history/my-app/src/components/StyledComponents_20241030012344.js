...
const themes = {
  clearDay: {
    ...
    containerBackground: "#FFFAF0", // Unique container background color
  },
  clearNight: {
    ...
    containerBackground: "#1F1F2E", // Unique container background color
  },
  cloudyDay: {
    background: "#b7c5d2",
    color: "#3f59743",
    ...
    containerBackground: "#F0F8FF", // Unique container background color
  },
  cloudyNight: {
    ...
    containerBackground: "#2B2B2B", // Unique container background color
  },
  rainyDay: {
    ...
    containerBackground: "#D1E7E3", // Unique container background color
  },
  rainyNight: {
    ...
    containerBackground: "#1A2E4D", // Unique container background color
  },
  snowyDay: {
    ...
    containerBackground: "#F0FFFF", // Unique container background color
  },
  snowyNight: {
    ...
    containerBackground: "#C0D6E4", // Unique container background color
  },
  windy: {
    ...
    containerBackground: "#B0E0E6", // Unique container background color
  },
};
