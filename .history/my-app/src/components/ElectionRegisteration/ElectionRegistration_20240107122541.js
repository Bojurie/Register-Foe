   ...
   const fetchData = async () => {
     ...
     try {
       ...
       if (!response || !response.data) {
         console.error("Failed to fetch candidates: No data returned");
         enqueueSnackbar("Failed to fetch candidates", { variant: "error" });
         return;
       }

       // Update this part based on the actual structure of your API response
       const candidatesFromResponse = response.data; // Assuming the API returns an array of candidates directly
