...
const TopicDisplay = ({ topic, likesCount, dislikesCount, votesCount, isAdmin, onLike, onDislike, onVote, onDelete }) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <p>Start: {formatDate(topic.dateStart)} - End: {formatDate(topic.dateEnd)}</p>
      </div>
