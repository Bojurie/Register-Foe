...
const handleMessageSend = async () => {
  if (!newMessage.trim() || !selectedConversation) {
    console.error("No message content or conversation selected.");
    return;
  }

  // Assuming conversation.participants is an array of user IDs
  ...
  try {
    ...
    await handleSendMessage(selectedConversation._id, recipientId, newMessage);
    setNewMessage("");
