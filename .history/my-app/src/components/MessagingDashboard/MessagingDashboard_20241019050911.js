...
const MessagingDashboard = () => {
  ...
  // Handle when a message item is clicked
  const handleMessageClick = (message) => {
    setSelectedConversation(message.sender); // Set selected conversation
    setSelectedMessage(message); // Set selected message
    setShowMessageInput(true); // Show the message input for reply
  };
          ...
          >
            ...
            {activeTab === "Inbox" && (
              <motion.div className="InboxContainer MessagesScrollable">
                ...
                {/* Show the MessageInput when a message is clicked */}
