...
const MessagingDashboard = () => {
  ...
  const fetchOutbox = useCallback(async () => {
    try {
      const messages = await fetchSentMessages(user._id);
  ...
  return (
    ...
    >
      <div className="MessagingDashboard-Header" onClick={toggleCollapse}>
        <h1>{isCollapsed ? "Show Messaging" : "Hide Messaging"}</h1>
      </div>
      ...
      <AnimatePresence>
        {!isCollapsed && (
          ...
          >
            ...
            <div className="MessagingDashboard-ContentInner">
              <AnimatePresence>
                {activeTab === "New" && (
                  <motion.div
                ...
                {activeTab === "Inbox" && (
                  ...
                  >
                    ...
                    <div className="MessagesScrollable">
