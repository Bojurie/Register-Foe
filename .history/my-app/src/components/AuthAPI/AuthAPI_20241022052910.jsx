...
const getConversations = async () => {
  try {
    const response = await axiosInstance.get(`/message/messages`); // Adjusted endpoint based on updated route
    console.log("Response from server:", response); // Log entire response
    ...
    const { conversations, messages } = response.data; // Destructure conversations and messages

    console.log("Fetched conversations:", conversations); // Log conversations
