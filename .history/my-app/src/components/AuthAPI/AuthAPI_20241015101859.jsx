...
const getConversations = async (conversationId) => {
  if (!conversationId) {
    console.warn("Conversation ID is missing.");
    return [];
  }
  ...
  try {
    ...
    // Check if the response was successful and contains the messages
    if (response.status === 200) {
