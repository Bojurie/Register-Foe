...
export const saveElection = async (electionData) => {
  try {
    const API_BASE_URL = "http://localhost:3000"; // Ensure this is your correct API base URL
    ...
    console.log(token); // Logging token after it is defined

    const response = await axios.post(
      `${API_BASE_URL}/savedElection/save-election`,
      electionData,
      {
        headers: {
