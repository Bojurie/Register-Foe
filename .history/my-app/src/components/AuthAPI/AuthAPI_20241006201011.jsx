...
const registerUser = async (formData) => {
  try {
    console.log("Sending request to register user with data:", formData); // Debug: Log FormData being sent

    const response = await axiosInstance.post(
      `${API_BASE_URL}/register`,
      formData
    );
    console.log("Response from register endpoint:", response.data); // Debug: Log response

    return response.data;
  } catch (error) {
    console.error("Error in registerUser:", error); // Debug: Log error details
