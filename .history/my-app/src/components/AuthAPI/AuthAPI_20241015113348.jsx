...
const getConversations = async () => {
  try {
    // Making a GET request to the inbox endpoint
    const response = await axiosInstance.get("/message/messages/inbox");
    ...
    console.info("Successfully fetched inbox messages:", response.data);

    // Return the data from the response (messages)
    return response.data;
  } catch (error) {
    console.error("Failed to fetch inbox messages:", error);
    throw new Error("Failed to fetch inbox messages"); // Throw an error to propagate it up the chain
  }
};
