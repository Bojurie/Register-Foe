...
const GetTopicsByCode = async (companyCode) => {
  ...
  try {
    const response = await axios.get(
      `${BASE_URL}/topics/byCompanyCode/${companyCode}`
    );
...
const getPastElections = async () => {
  try {
    const response = await axiosInstance.get(`/election/elections/past`);
    return response.data.elections; // Adjusted response to match the expected data
  } catch (error) {
