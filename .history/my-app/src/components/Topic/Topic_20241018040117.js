...
const StyledBox = styled(Box)({
  padding: "16px",
  background: "linear-gradient(135deg, #dfed71, #bfc3d2  )",
  borderRadius: "8px",
...
const Topic = ({ topic }) => {
  ...
  }); // Track if likes/dislikes have been fetched already

  // Check if the user is an admin or belongs to the company
  const canDelete =
    user?.role === "admin" ||
  ...
  // Handle delete action (only available for admins or company users)
