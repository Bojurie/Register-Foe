...
const handleCommentSubmit = async (commentId = null) => {
  ...
  if (commentId) {
    // Submitting a reply
    endpoint = `/vote/vote/topics/${topicId}/comments/${commentId}/replies`;
    requestBody.text = replies[commentId]?.trim(); // Get reply text
  } else {
    // Submitting a new comment
    endpoint = `/vote/vote/topics/${topicId}/comments`;
    requestBody.text = newComment.trim(); // Get comment text
  }
