...
const CommentSection = ({ topicId }) => {
  ...
  const handleReactionSubmit = async (commentId, type, isReply = false) => {
        ...
        {comments.map((comment) => (
          <Box key={comment._id} mb={2} p={2} border={1} borderColor="grey.300">
            ...
            <Box display="flex" alignItems="center" mt={1}>
              <IconButton
                onClick={() => handleReactionSubmit(comment._id, "like")}
              >
                <FaThumbsUp /> {comment.reactions?.likeCount || 0}
              </IconButton>
              <IconButton
                onClick={() => handleReactionSubmit(comment._id, "dislike")}
              >
            ...
            {comment.replies?.map((reply) => (
              ...
              >
                ...
                <Box display="flex" alignItems="center">
                  <IconButton
                    onClick={() =>
                      handleReactionSubmit(reply._id, "like", true)
                    }
                  >
                  ...
                  <IconButton
                    onClick={() =>
                      handleReactionSubmit(reply._id, "dislike", true)
                    }
                  >
