...
import { useTheme } from "../ThemeProvider"; // Ensure correct import path
import RainAnimation from "./RainAnimation"; // Ensure correct import path
import ThunderstormAnimation from "./ThunderstormAnimation"; // Ensure correct import path
import SnowAnimation from "./SnowAnimation"; // Ensure correct import path
import "./WeatherWidget.css";
import { useTheme } from "./StyledComponents"; // Ensure the correct path
import { ThemeContext } from "../ThemeContext"; // Ensure correct import path for ThemeContext
...
const WeatherWidget = () => {
  ...
  const theme = useTheme(); // Using the theme context here
  ...
  const background =
    (weather && weather.background) ||
    (currentTheme && currentTheme.background) ||
  ...
  const fetchWeatherData = useCallback(() => {
    ...
    setWeather({ temperature: temp, description, weatherIcon: icon });
