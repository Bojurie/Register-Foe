...
import "./WeatherWidget.css";
import { GlobalStyle, Container, Header } from '../StyledComponents'; // Path to your styled components
...
const WeatherWidget = () => {
  ...
  useEffect(() => {
    updateTheme(currentWeather); // Update theme based on the weather condition
  }, [currentWeather, updateTheme]);
