...
import { mockWeatherData, mockLocationData } from "./mockWeatherData"; // Ensure mock data is available
import { useTheme } from "../ThemeContext"; // Import useTheme from your theme context
