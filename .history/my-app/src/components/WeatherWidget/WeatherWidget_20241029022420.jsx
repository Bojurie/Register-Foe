...
import DaytimeBackground from "./DaytimeBackground";
import NighttimeBackground from "./NighttimeBackground";
import "./WeatherWidget.css";
...
const WeatherWidget = () => {
  ...
  const widgetStyle = {
    ...
    position: "relative", // Added to create a positioning context for absolute children
    zIndex: 2, // Ensure the widget is above backgrounds
  };

  useEffect(() => {
    if (weather) {
      updateTheme(weather.weatherIcon);
    }
  }, [weather, updateTheme]);
  ...
  const backgroundAnimation = useSpring({
    backgroundColor: isDayTime() ? "#87CEEB" : "#2C3E50",
    config: { duration: 500 },
  });
  ...
  return (
    <div className="WeatherWidget">
      ...
      <animated.div
        className="WeatherWidget-Background"
      ...
      >
        {error ? (
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5 }}
            style={widgetStyle} // Apply widget styles here
          >
            <motion.div className="CurrentTime">
              <p>{currentDateTime.time}</p>
            </motion.div>
