...
const WeatherWidget = ({ locationData }) => {
  ...
  useEffect(() => {
    if (weather) {
      ...
      const weatherIcon = weather.current.weather[0].icon; // Ensure weather.icon is accessed correctly
      updateTheme(weatherIcon, hour); // Update the theme based on the weather icon
