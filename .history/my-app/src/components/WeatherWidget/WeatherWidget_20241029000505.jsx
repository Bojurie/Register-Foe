...
import { DateTime } from "luxon";
import { motion } from "framer-motion";
import { WiDaySunny, WiNightClear, WiCloudy, WiRain, WiThunderstorm, WiSnow } from "react-icons/wi"; // Ensure you have react-icons installed

import { getWeatherData, mockLocationData } from "./mockWeatherData";
import "./WeatherWidget.css"; // Ensure you have this CSS file for styling
    ...
    >
      {error ? (
        ...
        >
          ...
          <motion.div className="Location">
            <p>
              {`${mockLocationData[city]?.city || "Your City"}, ${
                mockLocationData[city]?.state || "Your State"
              }, ${mockLocationData[city]?.country || "Your Country"}`}
            </p>
          </motion.div>
          <p>{currentDateTime.date}</p>
          <motion.div className="Temperature">
