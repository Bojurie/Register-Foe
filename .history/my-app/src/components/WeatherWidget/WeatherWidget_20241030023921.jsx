...
const WeatherWidget = ({ locationData }) => {
  ...
  const fetchWeatherData = useCallback(async () => {
    ...
    // Logging the API key and the request URL for debugging
    console.log("Using API Key:", apiKey); // Log the API key
    const requestUrl = `https://api.openweathermap.org/data/3.0/onecall?lat=${latitude}&lon=${longitude}&exclude=hourly,daily&appid=${apiKey}&units=imperial`;
