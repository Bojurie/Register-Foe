...
const ReminderModal = ({
  ...
  console.log("New Reminder Text:", newReminderText); // Log the reminder text to verify
            ...
            <div>
              <label>
                ...
                <input
                  ...
                  onChange={(e) => {
                    console.log("Reminder input changed:", e.target.value); // Log input change
              ...
              <motion.button
                onClick={() => {
                  console.log("Save Reminder button clicked"); // Log when the save button is clicked
                  handleSaveReminder(); // Call the save function
                }}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
