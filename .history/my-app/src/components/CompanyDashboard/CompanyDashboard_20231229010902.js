...
import { getElections, GetUsersByCode, getUsersByCompanyCode } from "../AuthContext/AuthContext";
  ...
  const fetchData = async () => {
    try {
      if (user && user.isCompany && user.companyCode) {
        ...
        const candidatesResponse = await getUsersByCompanyCode(user.companyCode);
