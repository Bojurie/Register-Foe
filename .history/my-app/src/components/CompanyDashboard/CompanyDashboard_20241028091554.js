...
const useCompanyDashboardData = (user) => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const [
        pastElections,
        upcomingNews, // This will contain the response from getCompanyNews
        upcomingElections,
        users,
        admins,
        topics,
      ...
      setState({
        pastElections,
        upcomingNews: upcomingNews.news, // Access the news directly
        upcomingElections,
        users,
        admins,
        topics,
      ...
      console.error("[ERROR] Fetching data in useCompanyDashboardData:", error);
      setState({
    ...
    <div className="CompanyDashboard">
      ...
      >
        ...
        <DashboardSections
          ...
          admins={state.admins}
          news={state.upcomingNews} // Pass the updated news
          users={state.users}
