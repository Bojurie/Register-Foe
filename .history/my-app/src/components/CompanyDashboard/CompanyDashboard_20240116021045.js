...
const fetchData = async () => {
  try {
    ...
    setCandidatesList(candidatesResponse || []); // Use candidatesResponse for candidatesList
    setUpcomingElections(electionResponse || []);
    setTopics(topicResponse || []);
    setUsers(userResponse || []);
    setAdmins(adminResponse || []); // Set the admins state

    setLoading({
      admins: false, // Set admins loading state to false
      candidates: false,
      elections: false,
      topics: false,
      users: false,
    ...
    if (loading.candidates || loading.elections || loading.topics || loading.users || loading.admins) {
