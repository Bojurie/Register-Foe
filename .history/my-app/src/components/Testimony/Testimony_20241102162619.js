...
import { TestimonyHeading } from "../StyledComponents";
...
const Testimony = () => {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      // Validate individual form fields and display specific error messages
      if (!name.trim()) {
  ...
  return (
    <div>
      <TestimonyHeading className="testimony-heading" onClick={openModal}>
