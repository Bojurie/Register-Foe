...
const ElectionDisplayFetcher = () => {
  ...
  const leadingCandidateId = currentElection.leadingCandidate?.candidateId;
  const candidates = currentElection.user.candidates || [];
  ...
  const leadingFirstName = leadingCandidateDetails.user.firstName;
  const leadingLastName = leadingCandidateDetails.user.lastName;
