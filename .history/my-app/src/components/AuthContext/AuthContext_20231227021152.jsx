  ...
  return useCallback(
    async (formData) => {
      try {
        ...
        console.log("Login response data:", response); // Add this line
        if (!response.token) {
        ...
        console.log("isCompany:", isCompany); // Log the value of isCompany

        const userData = { ...user, isCompany: !!isCompany };
        axios.defaults.headers.common["Authorization"] = `Bearer ${token}`;
        console.log("userData:", userData); // Log the user data with isCompany property
