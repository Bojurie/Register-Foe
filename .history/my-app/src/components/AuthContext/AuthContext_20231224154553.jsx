  ...
  async (formData) => {
    try {
      ...
      if (!response.data || typeof response.data !== "object") {
        ...
        enqueueSnackbar("Invalid server response", { variant: "error" });
        return;
      }
      ...
      if (!token || !user) {
        console.error(
          "Token or user data is missing from the response",
          response.data
        );
      ...
      if (error.response) {
        ...
        if (
          ...
          errorMessage = "Unexpected error response format from server";
        }
        ...
        errorMessage = "An error occurred while setting up the login request.";
      }
