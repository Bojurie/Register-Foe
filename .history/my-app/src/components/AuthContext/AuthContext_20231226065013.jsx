...
const handleLogin = useCallback(
  async (formData, enqueueSnackbar, dispatch, navigate) => {
    try {
      ...
      if (!response.data || !response.data.token) {
        enqueueSnackbar("Login failed: Token is missing or invalid response.", {
          variant: "error",
        });
        return;
      }
      ...
      // Prepare userData object based on user type
