...
const handleLogin = useCallback(
  async (formData) => {
    try {
      ...
      console.log("Raw axios response:", response); // Log the entire response
      ...
      if (isCompany) {
        ...
        userData = response.companyName; // Replace 'companyData' with the actual property name
      } else {
      ...
      setStoredUser(userData); // Storing user or company data
