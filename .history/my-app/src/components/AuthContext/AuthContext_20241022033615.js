...
const fetchInboxMessages = useCallback(
  async (conversationId) => {
    ...
    try {
      setLoading(true);
      const response = await getConversations(conversationId); // Fetch messages based on conversationId
...
const fetchConversationMessages = useCallback(
  async (conversationId) => {
    ...
    console.log("Fetching messages for conversation ID:", conversationId); // Log conversation ID

    try {
      setLoading(true);
      const response = await getConversations(conversationId); // Call your API
      console.log("Fetched messages from server:", response); // Log server response
