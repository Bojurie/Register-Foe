  ...
  return useCallback(
    async (formData) => {
      try {
        ...
        const isCompany = user.isCompany; // Correctly extract isCompany
        console.log("isCompany received from server:", isCompany);
        const userData = { ...user, isCompany }; // Set isCompany in userData
        axios.defaults.headers.common["Authorization"] = `Bearer ${token}`;
        ...
        enqueueSnackbar("Login successful!", { variant: "success" });
          if (isCompany) {
            // Redirect to the company dashboard or main page for companies
            navigate("/main");
          } else {
            // Redirect to the main dashboard for regular users
            navigate("/main");
          }
      } catch (error) {
