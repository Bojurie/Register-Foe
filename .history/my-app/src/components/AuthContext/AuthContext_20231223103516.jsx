...
const handleLogin = useCallback(
  async (formData) => {
    try {
      const user = await login(formData); // login function returns user data

      console.log("Login response data:", user);

      // Assuming the token is part of the user object
      const { token } = user;
      ...
      // Decode the token and dispatch login success
      ...
      // Log error, dispatch login error, and show error message
  ...
  [navigate, enqueueSnackbar, dispatch] // Add 'dispatch' to dependencies array if it's a prop or state
);
