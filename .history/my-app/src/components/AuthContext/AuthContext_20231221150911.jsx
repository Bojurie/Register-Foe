...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
   ...
   const logout = async () => {
     removeStoredUser(); // Clear user data from local storage
     removeStoredToken(); // Clear token from local storage
     dispatch({ type: ActionTypes.LOGOUT }); // Update state to reflect logout
