...
const getElections = useCallback(
  async (companyCode, electionId) => {
    ...
    try {
      ...
      return null; // Avoid throwing to ensure UI doesn't break unexpectedly
    }
  },
  [] // No dependencies since we want it to only be defined once
);
