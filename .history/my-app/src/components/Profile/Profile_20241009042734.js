...
const Profile = ({ user }) => {
  ...
  const userStatusMessages = useMemo(() => {
    ...
    if (user?.birthdayCountdown && user.birthdayCountdown !== "null") {
      messages.push({
        icon: <FaBirthdayCake />,
        text: `Birthday in ${user.birthdayCountdown}`,
      });
    }
    ...
    if (user?.anniversaryCountdown && user.anniversaryCountdown !== "null") {
      messages.push({
        icon: <FaCalendarAlt />,
        text: `Anniversary in ${user.anniversaryCountdown}`,
      });
    }
