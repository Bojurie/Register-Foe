...
export const CallendarWidget = styled(ContainerStyles)`
  background: ${({ theme }) =>
    theme.componentStyles.CallendarWidget.background};
  color: ${({ theme }) => theme.componentStyles.CallendarWidget.color};
  padding: ${({ theme }) => theme.componentStyles.CallendarWidget.padding};
  border-radius: ${({ theme }) =>
    theme.componentStyles.CallendarWidget.borderRadius};
`;
