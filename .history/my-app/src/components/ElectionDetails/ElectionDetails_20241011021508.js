...
import { useAuth } from "../AuthContext/AuthContext"; // Import authentication context to get user role
...
const ElectionDetails = ({
  ...
  const { user } = useAuth(); // Get the current user information
  ...
  return (
    <div className="ElectionDetails">
      ...
      {/* Show Delete Election Button for Admin/Company */}
