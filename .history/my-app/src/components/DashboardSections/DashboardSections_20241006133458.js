...
const DashboardSections = ({
  ...
  // Fetch elections along with candidates data from the backend
  useEffect(() => {
    const fetchElectionsWithCandidates = async () => {
      try {
        const response = await fetch("/election/elections"); // Assuming '/elections' endpoint provides populated data
