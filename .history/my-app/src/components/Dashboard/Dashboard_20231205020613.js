...
import ElectionsWidget from './ElectionsWidget';
...
const Dashboard = () => {
  ...
  useEffect(() => {
    setCurrentTime(new Date().toLocaleTimeString('en-US', { hour: 'numeric', minute: 'numeric', second: 'numeric' }));

    // Assume you have a function to get the user's location
    // For simplicity, let's say it returns an object with city, state, and coordinates
  ...
  return (
    ...
    >
      ...
      <p>Current Location: {currentLocation.city}, {currentLocation.state}</p>
