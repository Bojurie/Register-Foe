  ...
  return (
    ...
    >
        ...
        <nav className="Nav">
          <ul className="Nav-Links">
            ...
            {user && (
              <>
                <li>
                  <Link to="/saved-elections">Saved Elections</Link>
                </li>
                <li>
      ...
      <Routes>
        ...
        {user && (
          <>
            <Route path="main/saved-elections" element={<SavedElections />} />
            <Route path="main/past-elections" element={<PastElectionList />} />
          </>
        )}
      </Routes>
