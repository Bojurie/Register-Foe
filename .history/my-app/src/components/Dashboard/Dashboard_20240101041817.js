 ...
 useEffect(() => {
   ...
   const fetchTopics = async () => {
     ...
     if (user && user.isCompany && user.companyCode) {
       ...
       console.log("User object:", user); // Check if user object is as expected
       console.log("isCompany:", user?.isCompany); // Check isCompany value
       console.log("companyCode:", user?.companyCode); // Check companyCode value
