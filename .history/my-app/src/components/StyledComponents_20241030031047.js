...
export const ThemeProvider = ({ children }) => {
  ...
  const updateTheme = (weatherCode, hour) => {
    ...
    let themeKey = "clearDay";

    if (weatherCode.includes("rain"))
      themeKey = isNight ? "rainyNight" : "rainyDay";
    else if (weatherCode.includes("cloud"))
      themeKey = isNight ? "cloudyNight" : "cloudyDay";
    else if (weatherCode.includes("snow"))
      themeKey = isNight ? "snowyNight" : "snowyDay";
    else if (weatherCode.includes("wind")) themeKey = "windy";
    else if (weatherCode.includes("clear"))
      themeKey = isNight ? "clearNight" : "clearDay";
