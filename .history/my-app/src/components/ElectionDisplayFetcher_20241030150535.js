...
const ElectionDisplayFetcher = ({ companyCode }) => {
  ...
  // Sort candidates by vote percentage and select the leading candidate
  const leadingCandidateData = currentElection.candidates?.sort(
  ...
  return (
    <ElectionDisplay
      ...
      leadingCandidate={`${leadingCandidateData.candidateId.firstName} ${leadingCandidateData.candidateId.lastName}`}
      votePercentage={leadingCandidateData.votePercentage}
    />
  );
};
