...
const ElectionComponent = ({ election, onVote }) => {
  ...
  const [voteStatus, setVoteStatus] = useState(null); // Track voting status
    ...
    <div className="ElectionComponent" onClick={toggleModal}>
      ...
      {isModalOpen && (
        <ModalComponent
          ...
          contentProps={{ election, handleVote, voteStatus }} // Pass voteStatus and handleVote to ElectionDetails
        />
      )}
    </div>
  );
