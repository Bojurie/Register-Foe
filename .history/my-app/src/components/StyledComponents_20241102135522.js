...
export const CalendarDiv = styled(ContainerStyles)`
  background: ${({ theme }) => theme.componentStyles.CalendarDiv.background};
  color: ${({ theme }) => theme.componentStyles.CalendarDiv.color};
  padding: ${({ theme }) => theme.componentStyles.CalendarDiv.padding};
  border-radius: ${({ theme }) =>
    theme.componentStyles.CalendarDiv.borderRadius};
`;
