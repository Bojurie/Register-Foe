...
import { PastElectionsWrapper } from "../StyledComponents";
...
const PastElections = ({ pastElections }) => {
  ...
  return (
    <PastElectionsWrapper className="PastElections">
      <h2
                ...
                {pastElections.map((pastElection) => (
                  <motion.div key={pastElection._id} variants={itemVariants}>
                    <PastElectionItem
                      ...
                      totalVotes={pastElection.totalVotes}
                      winningCandidate={pastElection.winningCandidate}
                    />
                  </motion.div>
                ))}
              </motion.div>
