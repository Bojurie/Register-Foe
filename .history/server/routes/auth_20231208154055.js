...
const authMiddleware = require("../middleware/authMiddleware"); // You can implement the authentication middleware as described in the previous responses
const jwt = require("jsonwebtoken");
const { generateToken } = require("../utils/authUtils"); // You need to implement this function
