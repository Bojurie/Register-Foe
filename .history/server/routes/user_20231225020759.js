...
router.get("/users/byCompanyCode", async (req, res) => {
  try {
    // Retrieve the company code from the authenticated user's context
    // Replace with your actual method of retrieving the user's company code
