  ...
  try {
    ...
    const userResponse = isCompany
      ? {
          ...
          isCompany: true, // Ensure isCompany is explicitly set to true
        }
      : {
          firstName: account.firstName,
          lastName: account.lastName,
          email: account.email,
          isCompany: false, // Ensure isCompany is explicitly set to false
        };
console.log("isCompany set on server:", userResponse.isCompany);
