...
const { authenticateJWT, isAdmin } = require("../middleware/authMiddleware"); // Replace with the actual path to your auth file

// Company Registration Route (only accessible by admins)
