...
router.post("/elections/:electionId/vote", verifyToken, async (req, res) => {
  ...
  try {
    // Find the election by its ObjectId
    ...
    // Check if the current date is within the allowed voting period
    ...
    // Check if voting is allowed at this time
    ...
    // Add the election to the user's votedElections list and save the user
