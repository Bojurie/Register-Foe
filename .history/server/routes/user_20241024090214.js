...
router.get(
  ...
  async (req, res) => {
    ...
    // Log the requested company code for debugging
    console.log("Requested companyCode:", requestedCompanyCode);
    ...
    try {
      ...
      console.log("Users found for companyCode:", requestedCompanyCode, users);
