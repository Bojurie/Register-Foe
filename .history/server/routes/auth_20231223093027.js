...
router.post("/login", async (req, res) => {
  ...
  try {
    ...
    const userResponse = {
      _id: account._id,
      username: account.username,
      email: account.email, // Assuming both User and Company models have email
      firstName: account.firstName, // Assuming User model has firstName
      lastName: account.lastName, // Assuming User model has lastName
      isCompany: isCompany,
      token: token,
    };
