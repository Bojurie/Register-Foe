...
router.post("/save-election", isAuthenticated, async (req, res) => {
  try {
    // Get user ID from req.user (assuming you're using Passport.js for authentication)
    const userId = req.user._id;

    // Extract electionData from the request body
    const { electionData } = req.body;

    // Create a new Election document and save it to the database
