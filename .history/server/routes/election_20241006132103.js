...
//// new 
// Fetching an election with fully populated candidate details and user info
    ...
    const election = await Election.findById(req.params.id)
      .populate({
        ...
        populate: {
          path: 'user',
          model: 'User',
          select: 'firstName lastName role userProfileImage', // Select only fields that are needed
        },
      });
    if (!election) {
