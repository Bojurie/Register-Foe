...
router.get("/elections", async (req, res) => {
  try {
    // Fetch elections with populated candidates and their user details
    const elections = await Election.find().populate({
      ...
      populate: {
        ...
        model: "User",
        select:
          "firstName lastName age sex role userProfileDetail userProfileImage votesCount", // Select all required fields
      },
    });
