...
//       return res
//         .status(403)
//         .json({ error: "Access denied to this company's elections." });
//     }
...
//         (lead, candidate) =>
//           candidate.voteCount > (lead?.voteCount || 0) ? candidate : lead,
//         null
//       );
...
//         companyCode: requestedCompanyCode,
//       }),
//       currentElections: await Election.countDocuments({
//         companyCode: requestedCompanyCode,
//         endDate: { $gte: currentDate },
//       }),
//     });
//   } catch (error) {
//     return res.status(500).json({ error: "Error fetching election data." });
//   }
// });
