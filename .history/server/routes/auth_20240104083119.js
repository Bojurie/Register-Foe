...
router.post("/login", async (req, res) => {
  ...
  try {
    ...
    // Generate the token
    const token = generateToken(account, isCompany);

    // Prepare the user response including the user ID
    const userResponse = {
      id: account._id,
      ...(isCompany
        ? {
        ...
        : {
          ...
          console.log("Account object before token generation:", account);
