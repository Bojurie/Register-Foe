...
app.post("/topic/topics", async (req, res) => {
  // Authentication check (pseudo-code, implement according to your auth strategy)
  ...
  // Validation (add more as per your requirements)
