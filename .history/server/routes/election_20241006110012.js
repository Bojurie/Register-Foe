      ...
      const candidates = election.candidates
        .map((candidate) => {
          if (
            ...
            candidate.candidateId.user
          ) {
            return {
              id: candidate.candidateId.user._id,
              firstName: candidate.candidateId.user.firstName,
              lastName: candidate.candidateId.user.lastName,
              age: candidate.candidateId.user.age,
              userProfileImage: candidate.candidateId.user.userProfileImage,
